...
const tests = [
  ...
  { dev: true, homepage: 'https://create-ipfs-dapp.dev/', expect: '/' },
  {
    dev: true,
    homepage: 'https://create-ipfs-dapp.dev/test',
    expect: '/test/',
  },
  ...
  { dev: true, publicUrl: 'https://create-ipfs-dapp.dev/', expect: '/' },
  {
    dev: true,
    publicUrl: 'https://create-ipfs-dapp.dev/test',
    expect: '/test/',
  },
  ...
  {
    dev: true,
    publicUrl: 'https://create-ipfs-dapp.dev/',
    homepage: '/test',
    expect: '/',
  },
  {
  ...
  { dev: false, homepage: 'https://create-ipfs-dapp.dev/', expect: '/' },
  {
    dev: false,
    homepage: 'https://create-ipfs-dapp.dev/test',
    expect: '/test/',
  ...
  { dev: false, publicUrl: './test/path', expect: './test/path/' },
  {
    dev: false,
    publicUrl: 'https://create-ipfs-dapp.dev/',
    expect: 'https://create-ipfs-dapp.dev/',
  },
  {
    dev: false,
    publicUrl: 'https://create-ipfs-dapp.dev/test',
    expect: 'https://create-ipfs-dapp.dev/test/',
  },
