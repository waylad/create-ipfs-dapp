...
This package includes the shareable ESLint configuration used by [Create React App](https://github.com/waylad/create-ipfs-dapp).<br>
...
The easiest way to use this configuration is with [Create React App](https://github.com/waylad/create-ipfs-dapp), which includes it by default.
...
However, if you are using [Create React App](https://github.com/waylad/create-ipfs-dapp) and have not ejected, any additional rules will only be displayed in the [IDE integrations](https://facebook.github.io/create-ipfs-dapp/docs/setting-up-your-editor#displaying-lint-output-in-the-editor), but not in the browser or the terminal.
