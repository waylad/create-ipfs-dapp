...
cd "$temp_app_path"
npx create-ipfs-dapp test-app-dist-tag --scripts-version=@latest
...
cd "$temp_app_path"
npx create-ipfs-dapp test-app-version-number --scripts-version=1.0.17
...
cd "$temp_app_path"
npx create-ipfs-dapp test-app-typescript --template typescript
...
cd "$temp_app_path"
npx create-ipfs-dapp test-app-tarball-url --scripts-version=https://registry.npmjs.org/react-scripts/-/react-scripts-1.0.17.tgz
...
cd "$temp_app_path"
npx create-ipfs-dapp test-app-fork --scripts-version=react-scripts-fork
cd test-app-fork
...
npx create-ipfs-dapp test-app-should-not-exist --scripts-version=`date +%s` || true
...
# we will install a non-existing package to simulate a failed installation.
npx create-ipfs-dapp test-app-should-remain --scripts-version=`date +%s` || true
...
npx create-ipfs-dapp test-app-scoped-fork-tgz --scripts-version=$temp_app_path/enoah-scripts-0.9.0.tgz
...
npx create-ipfs-dapp test-app-nested-paths-t1/aa/bb/cc/dd
cd test-app-nested-paths-t1/aa/bb/cc/dd
npm start -- --smoke-test

# Testing a path that does not exist
cd "$temp_app_path"
npx create-ipfs-dapp test-app-nested-paths-t2/aa/bb/cc/dd
...
npx create-ipfs-dapp test-app-nested-paths-t3/aa/bb/cc/dd
