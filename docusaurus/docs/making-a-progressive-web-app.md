...
```sh
npx create-ipfs-dapp my-app --template ipfs-template-pwa
```

The TypeScript equivalent is:

```sh
npx create-ipfs-dapp my-app --template ipfs-template-pwa-typescript
```
...
[`src/index.js`](https://github.com/ipfs-template/pwa/blob/master/packages/ipfs-template-pwa/template/src/index.js)
file:
...
[`public/` directory](https://github.com/ipfs-template/pwa/tree/master/packages/ipfs-template-pwa/template/public/)
...
or customizing the one added by the `ipfs-template-pwa` (or
`ipfs-template-pwa-typescript`) template. You can use [additional
...
1. Users aren't always familiar with offline-first web apps. It can be useful to
   ...
   starting point, you can make use of the logic included in [`src/serviceWorkerRegistration.js`](https://github.com/ipfs-template/pwa/blob/master/packages/ipfs-template-pwa/template/src/serviceWorkerRegistration.js), which
...
[`public/manifest.json`](https://github.com/ipfs-template/pwa/blob/master/packages/ipfs-template-pwa/template/public/manifest.json), that you can customize with
details specific to your web application.

When a user adds a web app to their homescreen using Chrome or Firefox on
Android, the metadata in [`manifest.json`](https://github.com/ipfs-template/pwa/blob/master/packages/ipfs-template-pwa/template/public/manifest.json) determines what
