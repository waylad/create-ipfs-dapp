...
By default, the generated project supports all modern browsers. Support for Internet Explorer 9, 10, and 11 requires polyfills. For a set of polyfills to support older browsers, use [react-app-polyfill](https://github.com/waylad/create-ipfs-dapp/blob/main/packages/react-app-polyfill/README.md).
...
Note that **this project includes no [polyfills](https://github.com/waylad/create-ipfs-dapp/blob/main/packages/react-app-polyfill/README.md)** by default.

If you use any other ES6+ features that need **runtime support** (such as `Array.from()` or `Symbol`), make sure you are [including the appropriate polyfills manually](https://github.com/waylad/create-ipfs-dapp/blob/main/packages/react-app-polyfill/README.md), or that the browsers you are targeting already support them.
