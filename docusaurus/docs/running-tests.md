...
> [Read the migration guide to learn how to enable it in older projects!](https://github.com/waylad/create-ipfs-dapp/blob/main/CHANGELOG-0.x.md#migrating-from-023-to-030)
...
The [default configuration](https://github.com/waylad/create-ipfs-dapp/blob/main/packages/react-scripts/scripts/utils/createJestConfig.js) that Create React App uses for Jest can be overridden by adding any of the following supported keys to a Jest config in your package.json.
