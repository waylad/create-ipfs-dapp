...
- `react-scripts`
  ...
  - [#3730](https://github.com/waylad/create-ipfs-dapp/pull/3730) Print when `HOST` environment variable is set. ([@iansu](https://github.com/iansu))
...
- User Guide
  ...
  - [#3510](https://github.com/waylad/create-ipfs-dapp/pull/3510) Update User Guide with deploying to GitHub User pages. ([@aaronlna](https://github.com/aaronlna))
...
- `react-dev-utils`
  ...
  - [#3368](https://github.com/waylad/create-ipfs-dapp/pull/3368) Fix a crash in development mode in older browsers. ([@felthy](https://github.com/felthy))
...
- `react-dev-utils`
  ...
  - [#2282](https://github.com/waylad/create-ipfs-dapp/pull/2282) Add Windows Subsystem for Linux support to the error overlay. ([@noinkling](https://github.com/noinkling))
...
- `react-scripts`
  ...
  - [#1839](https://github.com/waylad/create-ipfs-dapp/pull/1839) Resolve `localhost` when offline (Windows). ([@bunshar](https://github.com/bunshar))
...
- `eslint-config-react-app`, `react-scripts`
  - [#2130](https://github.com/waylad/create-ipfs-dapp/pull/2130) Blacklist confusing global variables. ([@doshisid](https://github.com/doshisid))
...
- `react-dev-utils`
  - [#2125](https://github.com/waylad/create-ipfs-dapp/pull/2125) Only show the first compilation error. ([@gaearon](https://github.com/gaearon))
  - [#2120](https://github.com/waylad/create-ipfs-dapp/pull/2120) Omit ESLint warnings when there are ESLint errors. ([@gaearon](https://github.com/gaearon))
  - [#2113](https://github.com/waylad/create-ipfs-dapp/pull/2113) Prettify errors and warnings for webpack 2. ([@gaearon](https://github.com/gaearon))
  - [#1842](https://github.com/waylad/create-ipfs-dapp/pull/1842) Modularize and extract crash overlay to iframe. ([@Timer](https://github.com/Timer))
- `create-ipfs-dapp`
  - [#1811](https://github.com/waylad/create-ipfs-dapp/pull/1811) Allow creation of apps in empty Mercurial repos. ([@GreenGremlin](https://github.com/GreenGremlin))
- Other
  - [#1402](https://github.com/waylad/create-ipfs-dapp/pull/1402) Create empty package.json in e2e test (#1401). ([@matoilic](https://github.com/matoilic))

#### :memo: Documentation

- `react-scripts`
  - [#2193](https://github.com/waylad/create-ipfs-dapp/pull/2193) Fix webpack config typo. ([@Justkant](https://github.com/Justkant))
  - [#2137](https://github.com/waylad/create-ipfs-dapp/pull/2137) Remove live-editing since isn't accurate. ([@cesarvarela](https://github.com/cesarvarela))
  - [#2114](https://github.com/waylad/create-ipfs-dapp/pull/2114) Update Sass README. ([@kellyrmilligan](https://github.com/kellyrmilligan))
  - [#2081](https://github.com/waylad/create-ipfs-dapp/pull/2081) Fixed link for storybook. ([@scottrangerio](https://github.com/scottrangerio))
  - [#2052](https://github.com/waylad/create-ipfs-dapp/pull/2052) Fix instructions for serving with now. ([@davidascher](https://github.com/davidascher))
  - [#2058](https://github.com/waylad/create-ipfs-dapp/pull/2058) Clarify `.eslintrc` effects. ([@luftywiranda13](https://github.com/luftywiranda13))
  - [#2054](https://github.com/waylad/create-ipfs-dapp/pull/2054) Suggest to create `.eslintrc` for IDE lint plugins. ([@gaearon](https://github.com/gaearon))
  - [#2033](https://github.com/waylad/create-ipfs-dapp/pull/2033) Fix Netlify heading level. ([@benpickles](https://github.com/benpickles))
  - [#1987](https://github.com/waylad/create-ipfs-dapp/pull/1987) Suggest `node-sass` alternative. ([@michaelwayman](https://github.com/michaelwayman))
  - [#1988](https://github.com/waylad/create-ipfs-dapp/pull/1988) Update doc server example to work from any directory. ([@isramos](https://github.com/isramos))
  - [#1982](https://github.com/waylad/create-ipfs-dapp/pull/1982) Update information in User Guide for Enzyme dependency. ([@josephrace](https://github.com/josephrace))
  - [#1911](https://github.com/waylad/create-ipfs-dapp/pull/1911) Suggest Yarn in HTML template. ([@tmos](https://github.com/tmos))
  - [#1869](https://github.com/waylad/create-ipfs-dapp/pull/1869) User Guide: Removed blockquote from code section, due to markdown conflict. ([@stochris](https://github.com/stochris))
  ...
  - [#1717](https://github.com/waylad/create-ipfs-dapp/pull/1717) Add docs for apache's client side routing setting. ([@viankakrisna](https://github.com/viankakrisna))
  ...
  - [#1657](https://github.com/waylad/create-ipfs-dapp/pull/1657) Set Chrome userDataDir to be under .vscode folder. ([@ryansully](https://github.com/ryansully))
- Other
  - [#2135](https://github.com/waylad/create-ipfs-dapp/pull/2135) Add note about `yarn.lock`. ([@viankakrisna](https://github.com/viankakrisna))
  - [#2040](https://github.com/waylad/create-ipfs-dapp/pull/2040) Fix typo. ([@tijwelch](https://github.com/tijwelch))
  - [#1991](https://github.com/waylad/create-ipfs-dapp/pull/1991) Add folder structure docs for new contributors. ([@anilreddykatta](https://github.com/anilreddykatta))
  - [#1962](https://github.com/waylad/create-ipfs-dapp/pull/1962) Add sku to the list of alternatives. ([@markdalgleish](https://github.com/markdalgleish))
  - [#1799](https://github.com/waylad/create-ipfs-dapp/pull/1799) Improve phrasing. ([@moniuch](https://github.com/moniuch))
- `babel-preset-react-app`
  - [#1787](https://github.com/waylad/create-ipfs-dapp/pull/1787) Update side-effect documentation. ([@evenchange4](https://github.com/evenchange4))

#### :house: Internal

- `react-scripts`
  - [#2213](https://github.com/waylad/create-ipfs-dapp/pull/2213) Use some ES6 syntax. ([@shashkovdanil](https://github.com/shashkovdanil))
  - [#1913](https://github.com/waylad/create-ipfs-dapp/pull/1913) Add linked modules test. ([@Timer](https://github.com/Timer))
  ...
  - [#1715](https://github.com/waylad/create-ipfs-dapp/pull/1715) Remove unused `url` import in webpack config. ([@pd4d10](https://github.com/pd4d10))
  - [#1700](https://github.com/waylad/create-ipfs-dapp/pull/1700) Update extract-text-webpack-plugin to stable. ([@SimenB](https://github.com/SimenB))
- `react-dev-utils`, `react-scripts`
  - [#2209](https://github.com/waylad/create-ipfs-dapp/pull/2209) Move more logic from react-scripts to react-dev-utils. ([@gaearon](https://github.com/gaearon))
  - [#2138](https://github.com/waylad/create-ipfs-dapp/pull/2138) Add custom eslint formatter. ([@doshisid](https://github.com/doshisid))
- `babel-preset-react-app`, `react-scripts`
  - [#2175](https://github.com/waylad/create-ipfs-dapp/pull/2175) Resolve regenerator runtime relative to react-scripts. ([@gaearon](https://github.com/gaearon))
  - [#1894](https://github.com/waylad/create-ipfs-dapp/pull/1894) Re-disable babel modules transform. ([@Timer](https://github.com/Timer))
  - [#1742](https://github.com/waylad/create-ipfs-dapp/pull/1742) Switch to preset-env. ([@Timer](https://github.com/Timer))
- `create-ipfs-dapp`, `react-dev-utils`, `react-scripts`
  - [#1897](https://github.com/waylad/create-ipfs-dapp/pull/1897) Bump minimal Node version to 6. ([@ianschmitz](https://github.com/ianschmitz))
- Other
  - [#1868](https://github.com/waylad/create-ipfs-dapp/pull/1868) Fix AppVeyor CI. ([@darrenscerri](https://github.com/darrenscerri))
  - [#1825](https://github.com/waylad/create-ipfs-dapp/pull/1825) Added test to check for accidental extraneous dependencies. ([@lpalmes](https://github.com/lpalmes))
  - [#1876](https://github.com/waylad/create-ipfs-dapp/pull/1876) Fix AppVeyor CI. ([@darrenscerri](https://github.com/darrenscerri))
  ...
  - [#1688](https://github.com/waylad/create-ipfs-dapp/pull/1688) Pin and upgrade lerna version. ([@viankakrisna](https://github.com/viankakrisna))
  - [#1648](https://github.com/waylad/create-ipfs-dapp/pull/1648) Add `appveyor.yml`. ([@Timer](https://github.com/Timer))
- `babel-preset-react-app`, `create-ipfs-dapp`, `eslint-config-react-app`, `react-dev-utils`, `react-scripts`
  - [#1738](https://github.com/waylad/create-ipfs-dapp/pull/1738) Update to modern code style (ES6). ([@tuchk4](https://github.com/tuchk4))
- `eslint-config-react-app`
